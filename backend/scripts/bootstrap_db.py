...
- classes: teacher's classes with display name; used with class_students for roster
- class_students: roster rows; id is the "studentId" used in get-grades and submit-grades
...
# ---------------------------------------------------------------------------
# Schema (matches mock: users, classes, class_students, grade_submissions)
# ---------------------------------------------------------------------------
...
-- Roster: students in a class. This row's id is the "studentId" in get-grades / submit-grades
...
INSERT INTO class_students (id, class_id, name) VALUES
